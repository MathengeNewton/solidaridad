    ...
    return (
        <footer className="text-white rounded-lg shadow m-4">
            <div className="w-full mx-auto max-w-screen-xl p-4 md:flex md:items-center md:justify-between">
                <span className="text-sm text-gray-500 sm:text-center">© {year} <Link href="https://www.solidaridadnetwork.org/" target="_blank" rel="noopener noreferrer" className="hover:underline text-[#FFCC00]">Solidaridad Netwok</Link>. All Rights Reserved.
                </span>
