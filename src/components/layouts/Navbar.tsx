...
const Navbar: React.FC = () => {
  ...
  const handleLoginSuccess = (user: any) => {
    ...
    // Here, you might redirect the user to your dashboard or perform other actions
  };
  ...
  return (
    <nav className="bg-white fixed w-full z-20 top-0 start-0 border-b border-gray-200">
      <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
        ...
        <SSOButton provider="Google" onLoginSuccess={handleLoginSuccess} onLoginFailure={handleLoginFailure} />
        ...
        <div className={`items-center justify-between ${isOpen ? 'flex' : 'hidden'} w-full md:flex md:w-auto md:order-1`} id="navbar-sticky">
          <ul className="flex flex-col p-4 mt-4 font-medium border border-gray-100 rounded-lg bg-gray-50 md:p-0 md:space-x-8 md:flex-row md:mt-0 md:border-0 md:bg-white rtl:space-x-reverse">
            ...
            <li>
              <Link href="/"><div className="block py-2 px-3 text-white bg-blue-700 rounded md:bg-transparent md:text-blue-700 md:p-0" aria-current="page">Home</div></Link>
            </li>
            <li>
