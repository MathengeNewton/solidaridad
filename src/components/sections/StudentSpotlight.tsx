...
const StudentSpotlight: React.FC = () => {
  return (
    <section className="bg-white dark:bg-gray-900" id="students-spotlight">
      <div className="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6">
        <div className="mx-auto max-w-screen-sm text-center mb-8 lg:mb-16">
          <h2 className="mb-4 text-4xl tracking-tight font-extrabold text-gray-900 dark:text-white">Student Spotlight</h2>
