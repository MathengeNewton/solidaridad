...
import featuredCourses from '@/data/featuredCourses'; // Adjust the import path as necessary
        ...
        <section className="bg-white dark:bg-gray-900">
            <div className="max-w-screen-xl px-4 py-8 mx-auto ">
                {featuredCourses.map((course: FeaturedCoursesProps, index: number) => {
                    ...
                    return (
                        <div key={index} className={`grid grid-cols-1 lg:grid-cols-12 lg:gap-8 xl:gap-0 py-8`}>
                            <div className={`lg:col-span-6 ${imageOnRight ? 'lg:order-last' : ''}`}>
                                <Image src={course.image} alt={course.title} layout="responsive" width={500} height={375} />
                            </div>
